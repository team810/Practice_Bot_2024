...
class SwerveModuleRev implements SwerveModuleIO {
	...
	public SwerveModuleRev(SwerveModuleDetails details)
	{
		...
		drive = new CANSparkMax(details.driveID, CANSparkLowLevel.MotorType.kBrushless);
		steer = new CANSparkMax(details.steerID, CANSparkLowLevel.MotorType.kBrushless);
